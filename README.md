...
> Raycasting en C — Mini motor 3D inspirado en *Wolfenstein*. Implementa texturas, colisiones, minimapa y movimiento en tiempo real.  

🐚 **[Minishell](https://github.com/Minishell-cgil-gmaccha/Minishell-gmaccha-cgil)**  
> Shell Unix simplificada con pipes, redirecciones, built-ins y manejo de señales, emulando el comportamiento de Bash.  
